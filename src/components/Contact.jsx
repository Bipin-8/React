  ...
  return (
    <section id="contact" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className={`bg-slate-800/50 rounded-lg p-6 md:p-10 shadow-lg ${isVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-md focus:outline-none focus:ring-2 focus:ring-primary text-white"
                    required
                  />
                </div>
                ...
                <button 
                  type="submit" 
                  className="w-full px-6 py-3 rounded-md gradient-bg text-white font-medium hover:opacity-90 transition-opacity disabled:opacity-70"
